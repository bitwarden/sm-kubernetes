...
func (in *Project) DeepCopyInto(out *Project) {
	*out = *in
	if in.IncludedSecretIds != nil {
		in, out := &in.IncludedSecretIds, &out.IncludedSecretIds
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExcludedSecretIds != nil {
		in, out := &in.ExcludedSecretIds, &out.ExcludedSecretIds
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SecretMap != nil {
