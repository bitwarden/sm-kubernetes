...
//
//	mockgen -destination internal/controller/test/mocks/k8sClient_mock.go -package controller_test_mocks sigs.k8s.io/controller-runtime/pkg/client Client,SubResourceWriter
//
