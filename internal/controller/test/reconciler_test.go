...
var _ = Describe("BitwardenSecretReconciler", Ordered, func() {
	...
	BeforeEach(func() {
		fixture = *testutils.NewTestFixture(testContext)
	...
	Describe("Reconcile", func() {
		It("should complete a successful sync", func() {
			...
			err = fixture.K8sClient.Get(fixture.Ctx, types.NamespacedName{Name: testutils.BitwardenSecretName, Namespace: namespace}, createdSecret)
			Expect(err).NotTo(HaveOccurred())
		...
		/*
			...
			It("should create a new Kubernetes secret", func() {
				fixture.SetupDefaultCtrlMocks(false, nil) // Use default &bwSecretsResponse
